...
import { Discover as DiscoverIcon, Star1 } from "iconsax-react-native";
			...
			<Tab.Navigator
				...
				<Tab.Screen
					...
					options={{
						...
						tabBarIcon: ({ color }) => (
							<DiscoverIcon size={26} color={color} variant="Bold" />
						),
					}}
				/>
				<Tab.Screen
				...
				<Tab.Screen
					...
					options={{
						...
						tabBarLabelStyle: styles.label,
						tabBarIcon: ({ color }) => (
							<Star1 size={26} color={color} variant="Bold" fill={color} />
						),
					}}
				/>
			</Tab.Navigator>
